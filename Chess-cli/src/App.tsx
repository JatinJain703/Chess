...
export type Screen = "auth" | "login" | "signup" | "menu" | "waiting" | "game" | "gameover";
...
export default function App() {
    ...
    const connectWS = (t: string) => {
        ...
        // ← handle all incoming WS messages here
        ws.current.onmessage = (e) => {
            ...
            if (data.type === "GAME_START") {
                ...
                setGameInfo({
                    gameId: data.gameid,
                    color: data.whiteplayer === "You" ? "white" : "black",
            ...
            if (data.type === "move") {
                setFen(data.fen); // ← update board with new fen
            }
            ...
            if (data.type === "game_over") {
                ...
                if (result === "1/2-1/2") {
                    ...
                    // white wins
                    displayResult = color === "white" ? "You Win" : "You Lose";
                } else if (result === "0-1") {
                    // black wins
                    displayResult = color === "black" ? "You Win" : "You Lose";
                } else {
